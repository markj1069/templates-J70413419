define(`dc_title', `Letter Document Template')dnl
define(`dc_title_alternative', `Letter Template')dnl
define(`dc_title_short', `Letter Template')dnl
define(`dc_title_subtitle', `N/A')dnl
define(`dc_keyword_1', `letter')dnl
