define(`dc_title', `File Format Name')dnl
define(`dc_title_alternative', `File Format Man Page')dnl
define(`dc_title_short', `Script Name')dnl
define(`dc_title_subtitle', `Document Templates')dnl
define(`dc_keyword_1', `software')dnl
define(`dc_keyword_2', `man page')dnl
...
define(`dc_identifier_doc', `X77-6734-00')dnl
