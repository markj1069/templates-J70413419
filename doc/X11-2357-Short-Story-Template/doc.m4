define(`dc_title', `Short Story Document Template')dnl
define(`dc_title_alternative', `Short Story Template')dnl
define(`dc_title_short', `Short Story Template')dnl
define(`dc_title_subtitle', `N/A')dnl
define(`dc_keyword_1', `short story')dnl
...
define(`dc_format', `Short Story')dnl
define(`dc_format_extent', `(N/A)')dnl
define(`dc_format_medium', `Markdown')dnl
define(`dc_identifier', `X10-6715-00')dnl
...
define(`ndc_short story_date',`[Short Story Date]')dnl
