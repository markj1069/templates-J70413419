...
_STDIN_:: Does **dc_title** use standard in?

==== Other Input Files

What other input files does **dc_title** use?
...
Are there other output files created by **dc_title**.
...
dc_identifier_doc, {ldquo}dc_title_subtitle{rdquo} is licensed under the Creative Commons Attribution 4.0 Inter
national License (CC BY 4.0). You are free to share and adapt this work, provided you give appropriate credit,
...
== Synopsis
*cmd* {startsb}_OPT_{endsb} _FILE_
