define(`dc_title', `tool(1)')dnl
define(`dc_title_alternative', `Tool Name Man Page')dnl
define(`dc_title_short', `tool')dnl
define(`dc_title_subtitle', `Document Template')dnl
define(`dc_keyword_1', `software')dnl
define(`dc_keyword_2', `manpage')dnl
define(`dc_keyword_3', `template')dnl
...
define(`dc_description', `|
    ...
    and that authority is well-known.')dnl
define(`dc_description_abstract', `The *man pages*, short for *reference manual pages*, are your keys to Linux.')dnl
...
define(`dc_source', `https://github.com/markj1069/templates-J70413419/tree/master/doc/X77-6734/V01')dnl
define(`dc_relation', `02.00.01')dnl
...
define(`dc_identifier', `X77-6734-01')dnl
define(`dc_identifier_bibliographicCitation', `(N/A)')dnl
define(`dc_identifier_doc', `X77-6734-01')dnl
